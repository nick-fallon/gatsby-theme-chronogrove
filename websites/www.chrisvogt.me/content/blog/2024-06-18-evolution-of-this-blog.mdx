...
description: >
  The 12-year evolution of chrisvogt.me — from a CakePHP hobby project in 2012 through Jekyll and vanilla JS to the current GatsbyJS + React + Firebase architecture.
excerpt: >
  From a 4-page CakePHP site in 2012 to GatsbyJS + Firebase in 2024 — the full architectural history of chrisvogt.me.
---

Twelve years is a long time to keep the same hobby project alive. Most personal sites die during a framework upgrade or a busy quarter; this one survived PHP, Jekyll, React, and several career changes, accumulating features the way a house accumulates rooms. This post is the architectural history: how I got here, how it works now, and what comes next.
...
- [gatsby-theme-chronogrove](https://github.com/chrisvogt/gatsby-theme-chronogrove) – an open-source GatsbyJS theme for the front end.
