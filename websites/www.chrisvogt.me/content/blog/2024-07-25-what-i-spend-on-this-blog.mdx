...
description: >
  A line-by-line cost breakdown for running chrisvogt.me: $1.79/month for the site (Firebase, Netlify, Cloudinary, domain) and $8.99/month including Google Workspace email.
excerpt: >
  Running chrisvogt.me costs $1.79/month. Here's the full breakdown.
---
...
Building the whole stack by hand keeps costs low: each service does one job and most of them offer a free tier that more than covers personal-site traffic. The infrastructure includes a full API behind the GatsbyJS front end—all of it inside $1.79 a month.
